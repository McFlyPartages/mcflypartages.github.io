...
<Alert type="info"> l'antislash \ et mis automatiquement pour signaler que la ligne continue.</Alert>

<Alert type="warning"> ATTENTION les touches sont en QWERTY donc le `a=q`, `m = ;` et `_ = MAJ+°`</Alert>
