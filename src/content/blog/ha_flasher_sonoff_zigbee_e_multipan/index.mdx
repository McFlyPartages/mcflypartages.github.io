...
Si vous souhaitez juste flasher votre Sonoff ZBDongle E avec le firmware Thread uniquement, la procédure est la même. Il vous faudra juste selectionner le firmware.
...
Pour mettre Thread sur votre Sonoff ZBDongle E, il vous suffit de suivre la meme procedure de flash
