...
Le système offre des mises à jour OTA (Over-The-Air) régulières (souvent mensuelle) pour maintenir la sécurité et les performances.
...
Afin de faciliter l'installation pour les débutants, IodéOS met à disposition un programme [d'installation "automatique"](https://gitlab.com/iode/ota/-/tree/master/installer) pour certain téléphone.
...
iodéOS représente une option **intéressante** pour les utilisateurs soucieux de leur **vie privée** qui souhaitent une alternative à Android standard tout en conservant une **expérience** utilisateur **familière**. Elle accepte sans problème les applications bancaires, mais n'a pas Android Auto.
...
Il est possible d'acheter des telephones neuf ou reconditionnés depuis leur boutique.

**Mon avis :**

Je trouve cette ROM superbe, elle est agreable, il n'y a que le minimum d'application préinstallées que vous pouvait desactiver simplement. Le bloqueur est de tres bonne qualité et configurable, les mises a jour sont quasi mensuelles et la stabilité de la ROM est exemplaire. Il manque une plus grande compatibilité de telephone mais c'est en constante evolution.

#### /e/ OS

![Interface de Murena ou e OS](.img/murena_1.png "Interface de Murena ou e OS")

/e/OS est la solution grand public [compatible avec le plus de smartphone](https://doc.e.foundation/devices) et se base principalement sur LineageOS, mais avec des modifications significatives. Elle bénéficie aussi d'un installateur compatible avec certain smartphone (voir la [liste ici](https://doc.e.foundation/easy-installer)).
