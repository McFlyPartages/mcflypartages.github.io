...
description: Le but de cet article est d'approfondir ces notions depuis VMware,
  mais qui seront aussi valables sur VirtualBox ou autres logiciels de
  virtualisation.
pubDate: 07.24.2024
authors:
  - mcfly
...
Il est intéressant de créer vos VMs en mode NAT pour les connecter à internet et bénéficier des mises à jour. Ensuite, il vous suffit de créer un LAN-Segment pour simuler votre propre réseau en y ajoutant vos VMs client, serveurs, routeurs ou autres.
