...
Elle propose des alternatives open-source aux services Google, comme microG pour la gestion des services de base, F-Droid comme magasin d'applications par défaut, mais permet également l'installation d'autres magasins comme Aurora Store.
