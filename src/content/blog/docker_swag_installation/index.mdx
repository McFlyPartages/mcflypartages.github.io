...
description: SWAG une image docker qui exécute serveur web complet et un reverse
  proxy incluant Nginx, Php7, Certbot (client Let's Encrypt) et Fail2ban. Voyons
  comment le créer avec docker compose
pubDate: 03/26/2024
heroImage: .img/swag_reverse_proxy.png
authors:
  - mcfly
categories:
  - Docker
