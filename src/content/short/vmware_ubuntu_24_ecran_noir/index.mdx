...
1. Sur l'écran de connexion, cliquer sur votre utilisateur **MAIS** ne mettez pas le mot de passe de suite.
2. Cliquer sur l'engrenage en bas à droite puis sélectionner **Ubuntu sur Xorg**.

![Ouvrir sa session via Xorg sur Ubuntu](.img/ubuntu_ecran_connexion_xorg.png "Ouvrir sa session via Xorg sur Ubuntu")

1. Saisir votre mot de passe afin de vous connecter.
