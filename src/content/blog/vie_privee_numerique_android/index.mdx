...
Je n'ai pas testé CalyxOS, donc je ne pourrais pas donner mon avis. Il y a des procédures complètes depuis Windows, MacOS ou Linux disponibles. La liste des applications préinstallées est disponible [ici](https://calyxos.org/docs/guide/apps/#included-apps), mais je ne sais pas si elles sont désactivables facilement.
