...
Pour en sdavoir plus il y a deja pas mal de source sur le web dont [celle ci du site Domadoo](https://blog.domadoo.fr/89279-thread-protocole-domotique-matter/)
...
*Pas besoin de suivre ces etapes si vous souhaitez faire du Multi-PAN*

Si vous souhaitez juste flasher votre Sonoff ZBDongle E avec le firmware Thread uniquement, la procédure est la même. Il vous faudra juste selectionner le firmware OpenThread.

![Sélection du firmware Multi-PAN](.img/flash_dongle_web_selection_multipan_firmware.png "Sélection du firmware Multi-PAN")

## Remettre le firmware Zigbee

Pour remettre le firmware Zigbee sur votre Sonoff ZBDongle E. Suivez la même procedure mais en choissiant firmware Zigbee (EZSP).

![Sélection du firmware Multi-PAN](.img/flash_dongle_web_selection_multipan_firmware.png "Sélection du firmware Multi-PAN")

## Conclusion

Il est vrai que j'ai acheté la ZBDongle E uniquement pour tester ce multi protocole. Après plusieurs recherches, je ne pense pas qu'il y aura de grosses évolutions du firmware RCP.
...
Si vous souhaitez essayer d'autres versions de firmware que ceux qui sont avec le WebFlasher, retenez que les firmwares commencant par:
...
A la fin du nom de firmware il y a le Baudrate.
