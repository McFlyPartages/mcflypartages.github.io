...
Je n'ai pas testé CalyxOS, donc je ne pourrais pas donner mon avis. Ce que je remarque est q'il y a des procédures complètes depuis Windows, MacOS ou Linux disponibles pour installer CalyxOS sur votre smartphone. La liste des applications préinstallées est disponible [ici](https://calyxos.org/docs/guide/apps/#included-apps), mais je ne sais pas si elles sont désactivables facilement. N'hésitez pas à me faire vos retours sur les réseaux sociaux.
