...
Je vais être un peu chauvin, mais je vous avoue que depuis que je l'ai installé sur mon Xiaomi Mi 9, je ne l'ai jamais changé, même lorsque j'ai dû changer mon smartphone par un Google Pixel 6 reconditionné, j'ai orienté mon choix vers un téléphone supporté par IodéOS.
