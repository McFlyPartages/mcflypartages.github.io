...
Certaines ROMs sont orientées vers le respecte de la vie privée comme [Lineage for MicroG](https://lineage.microg.org/), [CalyxOS](https://calyxos.org/), [/e/OS](https://e.foundation/e-os/), [GrapheneOS](https://grapheneos.org/) et [IodéOS](https://iode.tech/fr/iodeos/) (ma préférée).
