...
description: >-
  L'installation d'une VM Windows Server 2019 sur VMware offre une plateforme
  idéale pour tester, déployer et gérer Active Directory, permettant aux
  administrateurs en herbes de créer un environnement de test ou de mettre en
  place une infrastructure complète de gestion d'identités.

  Cet article vous guidera à travers le processus d'installation d'une machine virtuelle Windows Server 2019 sur VMware.
pubDate: 07.17.2024
...
L'installation d'une VM Windows Server 2019 sur VMware offre une plateforme idéale pour tester, déployer et gérer Active Directory, permettant aux administrateurs en herbes de créer un environnement de test ou de mettre en place une infrastructure complète de gestion d'identités.
...
10. Vérifiez les paramètres puis cliquez sur `Finish` pour lancer l'installation.
    ...
    Une fois l'initialisation de la VLM réussie, elle va e lancer et installer Windows Server de façon autonome.
...
L'installation de Windows Server est terminé et VMware a installé VMware Tool permettant quelques manipulations entre les VMs et l'hôte.
