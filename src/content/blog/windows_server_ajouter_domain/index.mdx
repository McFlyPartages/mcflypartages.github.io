...
4. Redémarrez votre serveur.
   ...
   ![Demande de redemarrage de Window Server](.img/gestionnaire_serveur_changer_nom_redemarrer.png "Demande de redemarrage de Windows Server")



1. Sélectionnez Domaine et saisir le domaine que vous souhaitez utiliser (ici `mcflypartages.tuto`)
2. ![](.img/gestionnaire_serveur_changer_nom_ajout_domaine.png)
3. Validez avec le bouton OK
4. ![](.img/gestionnaire_serveur_defaut.png)
