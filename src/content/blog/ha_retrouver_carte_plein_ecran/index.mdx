---
draft: false
dossier: ha_retrouver_carte_plein_ecran
title: "Home Assistant : Un Dashboard en pleine page depuis la barre de menu."
description: Comment retrouver la carte Map ou n'importe qu'elle carte de Home
  Assistant en plein écran avec un accès depuis le menu.
pubDate: 06.28.2024
heroImage: .img/ha_dashboard_plein_ecran.png
authors:
  - mcfly
categories:
  - home assistant
...
### Remettre votre carte Map comme à l'origine.
...
![Éditer la vue dans un Dashboard Home Assistant](.img/dashboard_map_editer_vue.png "Editer la vue dans un Dashboard Home Assistant")
