...
1. Nous ajoutons une source externe, vous savez comment faire maintenant, sinon l'[article est ici](/blog/ha_addons/), ou plus simple en cliquant sur l'image ci-dessous ;
   [![Ajouter le dépôt Zigstar en un clic](.img/add_repository.svg)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%2Fmercenaruss%2Fzigstar_addons)
...
![Add-on Home Assistant Zigstar Silicon Labs FW Flasher](.img/add-on_zigstar_silicon_labs_fw_flasher.png "Add-on Home Assistant Zigstar Silicon Labs FW Flasher")

Une fois installé, vous allez dans `configuration`.
* Saisissez un nom bidon dans `Network Device`,
* Sélectionnez votre clé USB Sonoff Zigbee,
* Activez `Flash USB Devive`,
* Dans `Firmware URL`, coller l'URL de votre firmware (à récupérer [ici](https://github.com/darkxst/silabs-firmware-builder/tree/main/firmware_builds/zbdonglee),
Dans mon cas `https://github.com/darkxst/silabs-firmware-builder/raw/main/firmware_builds/zbdonglee/rcp-uart-802154-v4.4.2-zbdonglee-460800.gbl`
* `Bootloader Baudrate`, sélectionnez `460800`,
Enregistrer puis lancer l'add-on et rendez-vous dans `journal` pour voir si tout se passe bien.
...
[00:13:13] INFO: Starting universal-silabs-flasher with /dev/ttyACM0 (bootloader baudrate 460800)
2024-05-19 00:13:13 193f5383-zigstar-silabs-flasher universal_silabs_flasher.flash[158] INFO Extracted GBL metadata: NabuCasaMetadata(metadata_version=1, sdk_version='4.4.2', ezsp_version=None, ot_rcp_version=None, fw_type=<FirmwareImageType.RCP_UART_802154: 'rcp-uart-802154'>, baudrate=460800)
2024-05-19 00:13:13 193f5383-zigstar-silabs-flasher universal_silabs_flasher.flasher[158] INFO Probing ApplicationType.GECKO_BOOTLOADER at 460800 baud
2024-05-19 00:13:15 193f5383-zigstar-silabs-flasher universal_silabs_flasher.flasher[158] INFO Probing ApplicationType.CPC at 460800 baud
2024-05-19 00:13:15 193f5383-zigstar-silabs-flasher universal_silabs_flasher.flasher[158] INFO Detected ApplicationType.CPC, version '4.3.1' at 460800 baudrate (bootloader baudrate None)
2024-05-19 00:13:15 193f5383-zigstar-silabs-flasher universal_silabs_flasher.cpc[158] WARNING Failed to parse buffer bytearray(b'\x80'): ValueError('Invalid flag')
2024-05-19 00:13:15 193f5383-zigstar-silabs-flasher universal_silabs_flasher.cpc[158] WARNING Failed to parse buffer bytearray(b'\x00'): ValueError('Invalid flag')
2024-05-19 00:13:16 193f5383-zigstar-silabs-flasher universal_silabs_flasher.flasher[158] INFO Probing ApplicationType.GECKO_BOOTLOADER at 460800 baud
Traceback (most recent call last):
  ...
  File "/usr/local/lib/python3.11/asyncio/base_events.py", line 653, in run_until_complete
    return future.result()
           ^^^^^^^^^^^^^^^
  File "/usr/local/lib/python3.11/site-packages/universal_silabs_flasher/flash.py", line 392, in flash
    await flasher.enter_bootloader()
  File "/usr/local/lib/python3.11/site-packages/universal_silabs_flasher/flasher.py", line 305, in enter_bootloader
    await self.probe_app_type(types=[ApplicationType.GECKO_BOOTLOADER])
  File "/usr/local/lib/python3.11/site-packages/universal_silabs_flasher/flasher.py", line 261, in probe_app_type
    raise RuntimeError("Failed to probe running application type")
RuntimeError: Failed to probe running application type
[00:13:18] INFO: universal-silabs-flasher-up script exited with code 1
...
```
<Alert type="warning"> Il faut que les add-ons Zigbee2MQTT ou ZHA soient arrêtés, sinon ça ne marchera pas.</Alert>
