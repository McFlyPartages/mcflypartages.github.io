...
#### Installer TWRP pour Android 14 sur Xiaomi Redmi Note 8 Pro
...
S'il redémarre sur TWRP, ????????????????Revenir sur la rom MIUI

Pour revenir à la Rom d'origine, il vous suffit soit de passer par la méthode TWRP et copier-coller la dernière version de la rom Xiaomi pour votre smartphone ou alors via la méthode ADB.
