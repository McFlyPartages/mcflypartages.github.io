...
Elle propose des alternatives open-source aux services Google, comme microG pour la gestion des services de base, FdF-Droid comme magasin d'applications par défaut, mais permet également l'installation d'autres magasins comme Aurora Store.

Mises à jour : Le système offre des mises à jour OTA (Over-The-Air) régulières pour maintenir la sécurité et les performances.

Compatibilité : iodeOS est disponible pour une variété d'appareils, bien que la liste soit plus limitée que celle de ROMs plus établies comme LineageOS.

Fonctionnalités de confidentialité : Elle intègre des outils pour mieux contrôler les permissions des applications et limiter le suivi.
