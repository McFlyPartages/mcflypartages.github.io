...
L'équipe de CalyxOS fournit des mises à jour de sécurité rapides et régulières. Elle intègre des outils comme Seedvault pour la sauvegarde chiffrée, Datura Firewall pour un contrôle granulaire du réseau ainsi que le réseaux Tor préinstallé.
...
Je n'ai pas testé CalyxOS, donc je ne pourrais pas donner mon avis. Il y a des procedures complete depuis Windows, MacOS ou Linux disponible. La liste des applications préinstallées est disponible [ici](https://calyxos.org/docs/guide/apps/#included-apps), mais je ne sais pas si elles sont desactivables facilement.
