...
Nous allons flasher la clé Sonoff directement avec un module complementaire de Home Assistant, mais il est possible de la flasher directement avec un navigateur compatible WebSerial API comme Chrome (Chromium aussi en effectuant ou Edge.
