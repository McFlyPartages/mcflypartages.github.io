...
authors:
  - mcfly
upDate: 12/18/2023
dossier: balena_etcher_installation_utilisation
title: Balena Etcher - Flasher des images de votre OS sur carte SD, clé USB ou
  disque dur
description: Comment installer un OS sur un support amovible (clé USB, carte
  Micro SD, etc) avec Balena Etcher.
pubDate: 12/10/2023
categories:
  - linux
tags:
