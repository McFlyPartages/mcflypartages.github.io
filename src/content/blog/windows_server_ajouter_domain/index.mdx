...
<Alert type="info">Ce choix doit se faire en fonction des versions de Windows Server que vous avez dans votre domaine en s'adaptant a la version la plus basse disponnible dans votre domaine. Nous avons une seule installation de Windows Server (celle-ci) qui est en 2022 ou 2019.</Alert>
...
* [IT-Connect](https://www.youtube.com/@IT-Connect) && Playlist [Active Directory](https://www.youtube.com/watch?v=K8j4LuOG8X0&list=PLSuzYIVSEUT5ZXGVVP8LBw2B7GS2uaNhJ) && Article écrits sur [Active Directory](https://www.it-connect.fr/tag/active-directory/)
