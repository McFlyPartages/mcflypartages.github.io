...
[Ferdium](https://ferdium.org/) est une application de bureau gratuite et open-source qui agit comme un hub central pour vos services de messagerie, de réseaux sociaux et d'autres services de productivités ([Nextcloud](https://nextcloud.com/), [Kdrive](https://www.infomaniak.com/fr/kdrive), [Home Assistant](https://www.home-assistant.io/), etc, etc). Inspiré par [Franz](https://meetfranz.com/), un autre agrégateur de services populaire, [Ferdium](https://ferdium.org/) va plus loin en offrant des fonctionnalités avancées et une plus grande personnalisation.
