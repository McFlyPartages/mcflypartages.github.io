...
Vous vous souvenez peut-être que j'ai fait un article sur le [flash de la clé Sonoff ZBDongle mais la version **P**](/blog/ha_flasher_sonoff_zigbee/) pour enlever la limite du nombre d'appareils imposé par Sonoff ? Et bien attention car nous allons pas utiliser le même add-on, mais par contre, c'est la même source à ajouter.
